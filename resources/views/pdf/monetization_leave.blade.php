...
<head>
    ...
    <title>Mometization of Leave Credits</title>
</head>
<style>
    table,
    th,
...
<body>
    <table style="width: 90%; margin: 0 auto; border-collapse: collapse; align-items:center; border: 2px solid black;">
        <tr>
            <td colspan="4" style="position: relative; height: 80px; text-align: center; vertical-align: middle;">
                ...
                <div style="display: inline-block; padding-top: 30px; font-family: Arial, Helvetica, sans-serif">
                    ...
                    <div style="font-size: 13px; font-weight: bold">MONETIZATION OF LEAVE CREDITS</div>
        ...
        <!-- second text table -->
        <tr>
            <td colspan="4" style="font-weight: bold; font-family: Arial, Helvetica, sans-serif; font-size: 15px">For monetization of 50% or more:</td>
        </tr>
        ...
        @php
        $loopTexts = [
        'Clinical abstract/medical procedures to be undertaken in case of health, medical, hospital needs',
