...
<head>
    ...
    <title>PPCLDO INDIVIDUAL LIVELIHOOD ASSISTANCE</title>
</head>
<style>
    table,
    th,
...
<body>
    <table style="width: 90%; margin: 0 auto; border-collapse: collapse; align-items:center; border: 2px solid black;">
        <tr>
            <td colspan="4" style="position: relative; height: 80px; text-align: center; vertical-align: middle;">
                ...
                <div style="display: inline-block; padding-top: 30px; font-family: Arial, Helvetica, sans-serif">
                    ...
                    <div style="font-size: 13px; font-weight: bold">PPCLDO INDIVIDUAL LIVELIHOOD ASSISTANCE</div>
        ...
        @php
        $loopTexts = [
        'Endorsement/Approval by the Governor/Administrator/Authorized Signatory',
        'Application Form',
        'Individual Profile',
        'Livelihood Project Proposal',
        'Barangay Certificate of Residency',
        'Valid ID or alternative documents for identification of the client/beneficiary, with 3 specimen signatures',
