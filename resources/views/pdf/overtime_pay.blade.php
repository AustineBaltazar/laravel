...
<body>
    <table style="width: 90%; margin: 0 auto; border-collapse: collapse; align-items:center; border: 2px solid black;">
        <tr>
            <td colspan="4" style="position: relative; height: 80px; text-align: center; vertical-align: middle;">
                ...
                <div style="display: inline-block; padding-top: 30px; font-family: Arial, Helvetica, sans-serif">
                    ...
                    <div style="font-size: 13px; font-weight: bold">OVERTIME PAY</div>
        ...
        @php
        $loopTexts = [
        'Overtime authority stating the necessity and urgency of the work to be done, names of personnel, the purpose of expected ouputs, specific period of such services and the manner of compensating the same i.e CTO or paid in cash',
