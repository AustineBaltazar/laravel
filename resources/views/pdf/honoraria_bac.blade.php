...
<head>
    ...
    <title>HONORARIA (Government Personnel Involved in Goverment Procurement (BAC)</title>
</head>
<style>
    table,
    th,
...
<body>
    <table style="width: 90%; margin: 0 auto; border-collapse: collapse; align-items:center; border: 2px solid black;">
        <tr>
            <td colspan="4" style="position: relative; height: 80px; text-align: center; vertical-align: middle;">
                ...
                <div style="display: inline-block; padding-top: 30px; font-family: Arial, Helvetica, sans-serif">
                    ...
                    <div style="font-size: 13px; font-weight: bold">HONORARIA (Government Personnel Involved in Goverment Procurement (BAC)</div>
        ...
        'Notices of Award to the winning bidders of procurement activity being claimed',
        'Certification that the procurement involves competitive bidding',
        'Attendace sheet listing the names of attendees to the BAC meetings',
        'Certification issued by the Chief Accountant that the amounts received by the recipients do not exceed 25% of the annual basic salaries',
        'Background Investigation Report, if applicable',
        ...
        <tr>
            <td style="width: 15%; font-size: 20px; text-align: center;"></td> <!-- blank table for checkbox-->
