...
<body>
    <table style="width: 90%; margin: 0 auto; border-collapse: collapse; align-items:center; border: 2px solid black;">
        <tr>
            <td colspan="4" style="position: relative; height: 80px; text-align: center; vertical-align: middle;">
                ...
                <div style="display: inline-block; padding-top: 30px; font-family: Arial, Helvetica, sans-serif">
                    ...
                    <div style="font-size: 13px; font-weight: bold">LOYALTY PAY</div>
        ...
        "Letter to the bank to credit employees' account of their salaries and other claims stamped \"Received\" by the bank, if applicable",
        'Validated deposits slips/LDDAP-ADA, if applicable',
        'Service Record (original)',
        'Certificate of non-payment from previous office (for transferee)',
        'Certification from HRMDO that the claimant has not incurred more than 50 days leave without pay within the preceding 5-year period, as the case maybe, or proof of eligibility to receive incentive/service recognition',
